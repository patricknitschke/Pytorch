...
model.fc = nn.Linear(num_ftrs, 2) # input features of the last layer, only 1 fc layer in ResNets - check source code
...
# We update all parameters of the network a little bit -> finetuning
